...
namespace turtle {
     ...
     */
    //% blockId=turtleForward block="前进 %steps|步"
     ...
     */
    //% blockId=turtleBack block="后退 %steps|步"
     ...
     */
    //% blockId=turtleTurnLeft block="向左转"
     ...
     */
    //% blockId=turtleTurnRight block="向右转"
    ...
    //% x.min=0 x.max=4
    //% y.min=0 y.max=4
    //% blockId=turtleSetPosition block="设置位置为 x: %x|y: %y"
    //% weight=87
     ...
     */
    //% blockGap=8
    //% blockId=turtlePen block="画笔 %mode"
    //% weight=65
    ...
    //% blockId=turtleSetBrightness block="设置亮度 %brightness"
     ...
     */
    //% blockGap=8
    //% blockId=turtleSetSpeed block="设置速度 %speed"
